...
public class Clan implements Iterable<UnitMember> {
    ...
    protected Map<Integer, Skill> _skills = new TreeMap<>();
    protected Map<Integer, RankPrivs> _privs = new TreeMap<>();
    protected Map<Integer, SubUnit> _subUnits = new TreeMap<>();
    private int _allyId;
    private int _level;
    ...
    private ArrayList<Integer> classesNeeded = new ArrayList<>();
