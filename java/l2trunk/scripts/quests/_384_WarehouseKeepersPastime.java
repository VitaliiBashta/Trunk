...
public class _384_WarehouseKeepersPastime extends Quest implements ScriptFile {
    ...
    protected static class Bingo extends l2trunk.scripts.quests.Bingo {
        ...
        Bingo(boolean BigGame, QuestState qs) {
