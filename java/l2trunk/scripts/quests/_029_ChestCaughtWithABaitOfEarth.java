...
public class _029_ChestCaughtWithABaitOfEarth extends Quest implements ScriptFile {
    private final int Willie = 31574;
    private final int Anabel = 30909;

    private final int SmallPurpleTreasureChest = 6507;
    private final int SmallGlassBox = 7627;
    private final int PlatedLeatherGloves = 2455;
