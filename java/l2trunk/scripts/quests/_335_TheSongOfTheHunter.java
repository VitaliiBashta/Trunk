...
public final class _335_TheSongOfTheHunter extends Quest {
    ...
    public static class Request {
        ...
        final int request_item;
        final int request_count;
        final int reward_adena;
        final String text;
        final Map<Integer, Integer> droplist = new HashMap<>();
        final Map<Integer, int[]> spawnlist = new HashMap<>();

        Request(int requestid, int requestitem, int requestcount, int rewardadena, String txt) {
        ...
        Request addDrop(int kill_mob_id, int chance) {
            droplist.put(kill_mob_id, chance);
            return this;
        }

        Request addSpawn(int kill_mob_id, int spawn_mob_id, int chance) {
            try {
