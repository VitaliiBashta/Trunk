...
public class _123_TheLeaderAndTheFollower extends Quest implements ScriptFile {
    private final int NEWYEAR = 31961;
    ...
    private final int D_CRY = 1458;
    private final int D_CRY_COUNT_HEAVY = 721;
    private final int D_CRY_COUNT_LIGHT_MAGIC = 604;

    private final int CLAN_OATH_HELM = 7850;

    private final int CLAN_OATH_ARMOR = 7851;
    private final int CLAN_OATH_GAUNTLETS = 7852;
    private final int CLAN_OATH_SABATON = 7853;

    private final int CLAN_OATH_BRIGANDINE = 7854;
    private final int CLAN_OATH_LEATHER_GLOVES = 7855;
    private final int CLAN_OATH_BOOTS = 7856;

    private final int CLAN_OATH_AKETON = 7857;
    private final int CLAN_OATH_PADDED_GLOVES = 7858;
    private final int CLAN_OATH_SANDALS = 7859;
