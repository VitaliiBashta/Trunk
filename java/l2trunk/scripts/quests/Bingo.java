...
public abstract class Bingo {
    ...
    private final static String msg_begin = "I've arranged 9 numbers on the panel.<br>Now, getBonuses your %choicenum% number.";
    ...
    private final static String[] nums = {"first", "second", "third", "fourth", "fifth", "final"};
    int lines;
