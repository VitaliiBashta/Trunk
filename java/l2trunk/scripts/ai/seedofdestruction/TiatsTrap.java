...
public final class TiatsTrap extends DefaultAI {
    private static final List<Integer> holdTraps = Arrays.asList(18720, 18721, 18722, 18723, 18724, 18725, 18726, 18727, 18728);
    private static final List<Integer> damageTraps = Arrays.asList(
    ...
    private static final List<Integer> stunTraps = Arrays.asList(18729, 18730, 18731, 18732, 18733, 18734, 18735, 18736);
