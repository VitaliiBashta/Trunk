...
class RateBonus extends Functions {
    ...
    private static String getPkButton(int i) {
        return "<a action=\"bypass -h scripts_services.RateBonus:get " + i + "\"> for " + i + " PK - " + Config.SERVICES_WASH_PK_PRICE * i + " " + ItemHolder.INSTANCE.getTemplate(Config.SERVICES_WASH_PK_ITEM).getName() + "</a><br>";
    }
