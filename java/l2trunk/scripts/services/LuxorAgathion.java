 ...
 * @Date: 11/06/2008
 */
class LuxorAgathion extends Functions {
    // Ингридиенты:
    ...
    // Продукция:
    private static final int[] ANGEL_BRACELET_IDS = new int[]{10320, 10316, 10317, 10318, 10319};
    private static final int[] DEVIL_BRACELET_IDS = new int[]{10326, 10322, 10323, 10324, 10325};
