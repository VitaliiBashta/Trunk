...
public final class BuyWashPk extends Functions {
    ...
    public void list() {
        ...
        String html = HtmCache.INSTANCE.getNotNull("scripts/services/BuyWashPk.htm", player);
    ...
    private static String getPkButton(int i) {
        return "<a action=\"bypass -h scripts_services.BuyWashPk:get " + i + "\"> for " + i + " PK - "
                + Config.SERVICES_WASH_PK_PRICE * i + " " + ItemHolder.getTemplate(Config.SERVICES_WASH_PK_ITEM).getName()
                + "</a><br>";
    }
