...
class exchange extends Functions {
    ...
    public void showBabyPetExchange() {
        ...
        ItemTemplate item = ItemHolder.INSTANCE.getTemplate(Config.SERVICES_EXCHANGE_BABY_PET_ITEM);
        String out = "";
    ...
    public void showErasePetName() {
        ...
        ItemTemplate item = ItemHolder.INSTANCE.getTemplate(Config.SERVICES_CHANGE_PET_NAME_ITEM);
        String out = "";
