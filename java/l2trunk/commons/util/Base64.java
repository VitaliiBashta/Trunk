...
public class Base64 {
    ...
    public static byte[] decode(String s) {
        ...
        if (bytes.length >= 2) {
            ...
            if (bytes.length >= 4 && java.util.zip.GZIPInputStream.GZIP_MAGIC == head) {
                ...
                try (java.io.ByteArrayInputStream bais = new java.io.ByteArrayInputStream(bytes); java.util.zip.GZIPInputStream gzis = new java.util.zip.GZIPInputStream(bais); java.io.ByteArrayOutputStream baos = new java.io.ByteArrayOutputStream()) {
    ...
    static class InputStream extends java.io.FilterInputStream {
        ...
        InputStream(java.io.InputStream _in, int options) {
            super(_in);
    ...
    static class OutputStream extends java.io.FilterOutputStream {
        ...
        OutputStream(java.io.OutputStream _out, int options) {
            super(_out);
            breakLines = (options & DONT_BREAK_LINES) != DONT_BREAK_LINES;
            encode = (options & ENCODE) == ENCODE;
