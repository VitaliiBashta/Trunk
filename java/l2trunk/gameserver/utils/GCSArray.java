 ...
 *
 * @see l2trunk.util.GArray - базовая версия
 * @see l2trunk.util.GCArray - конкуррентнобезопасная версия
 * @see l2trunk.util.GSArray - синхронизированная версия
 */
public class GCSArray<E> implements Collection<E> {
    ...
    private GCSArray(int initialCapacity) {
        super();
    ...
    private synchronized E[] toNativeArray() {
    ...
    private synchronized E remove(int index) {
        RangeCheck(index);
