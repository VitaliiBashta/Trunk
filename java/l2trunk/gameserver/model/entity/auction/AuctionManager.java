...
public final class AuctionManager {
    ...
    private final Map<Integer, Auction> _auctions = new HashMap<>();
    private final List<Integer> _deadAuctions = new ArrayList<>();
    private final Map<Integer, Long> _lastMadeAuction = new HashMap<>();
    ...
    private Auction getAuction(ItemInstance item) {
     ...
     */
    private void addAdenaToSeller(int sellerObjectId, long adena) {
        int objId = -1;
    ...
    private void deleteAuction(Player seller, Auction auction) {
        if (auction == null) {
