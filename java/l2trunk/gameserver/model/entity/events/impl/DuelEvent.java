...
import l2trunk.gameserver.network.serverpackets.ExDuelStart;
import l2trunk.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
...
public abstract class DuelEvent extends GlobalEvent implements Iterable<DuelSnapshotObject> {
    ...
    protected abstract void playerExit(Player player);
    ...
    IStaticPacket canDuel0(Player requestor, Player target) {
