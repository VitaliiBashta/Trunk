...
public final class SchemeBufferInstance extends NpcInstance {
    ...
    private static void deleteScheme(int eventParam1, Player player) {
        ...
        for (PlayerScheme scheme : player.getBuffSchemes()) {
            if (scheme.schemeId == eventParam1) {
    ...
    private static class SingleBuff {
        final int _buffClass;
        final String _buffType;
        final int _buffId;
        final int _buffLevel;
        final String _buffName;
        int _forClass;
        boolean _canUse;
    ...
    public static class PlayerScheme {
        ...
        final List<SchemeBuff> schemeBuffs;
