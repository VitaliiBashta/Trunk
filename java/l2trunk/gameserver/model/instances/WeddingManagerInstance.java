...
import l2trunk.gameserver.model.entity.Couple;
...
public class WeddingManagerInstance extends NpcInstance {
    ...
    public void onBypassFeedback(Player player, String command) {
        ...
        } else if (player.isMaried()) // already married ?
        {
            ...
            player.sendMessage(new CustomMessage("l2trunk.gameserver.model.instances.L2WeddingManagerMessage", player));
            player.setMaried(true);
            player.setMaryRequest(false);
            ptarget.sendMessage(new CustomMessage("l2trunk.gameserver.model.instances.L2WeddingManagerMessage", ptarget));
            ...
            Announcements.getInstance().announceByCustomMessage("l2trunk.gameserver.model.instances.L2WeddingManagerMessage.announce", new String[]{player.getName(), ptarget.getName()});
