...
public class AdminClanHall implements IAdminCommandHandler {
    ...
    private void showClanHallPage(Player activeChar, ClanHall clanhall) {
        ...
        replyMSG.append("<td><button value=\"teleport getPlayer\" action=\"bypass -h admin_clanhallteleportself " + clanhall.getId() + " \" width=80 height=15 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td></tr>");
        replyMSG.append("</table>");
        replyMSG.append("</center>");
        replyMSG.append("</body></html>");
