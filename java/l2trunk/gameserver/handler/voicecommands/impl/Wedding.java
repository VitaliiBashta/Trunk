...
public class Wedding implements IVoicedCommandHandler {
    ...
    private static class CoupleAnswerListener implements OnAnswerListener {
        ...
        CoupleAnswerListener(Player player1, Player player2) {
        ...
        public void sayYes() {
            ...
            player1.sendMessage(new CustomMessage("l2trunk.gameserver.model.L2Player.EngageAnswerYes", player2));
        }
        ...
        public void sayNo() {
            ...
            player1.sendMessage(new CustomMessage("l2trunk.gameserver.model.L2Player.EngageAnswerNo", player2));
        }
    }
