...
public class ExServerPrimitive extends L2GameServerPacket {
     ...
     * @param z             the z coordinate for this point
     */
    private void addPoint(String name, Color color, boolean isNameColored, int x, int y, int z) {
    ...
    private static class Point {
        ...
        Point(String name, int color, boolean isNameColored, int x, int y, int z) {
            _name = name;
            _color = color;
    ...
    private static class Line extends Point {
        ...
        Line(String name, int color, boolean isNameColored, int x, int y, int z, int x2, int y2, int z2) {
