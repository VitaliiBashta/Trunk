...
public enum SystemMsg implements IStaticPacket {
    ...
    // Message: Please getBonuses your race.
    PLEASE_SELECT_YOUR_RACE(81),
    // Message: Please getBonuses your occupation.
    PLEASE_SELECT_YOUR_OCCUPATION(82),
    // Message: Please getBonuses your gender.
    ...
    // Message: Do you wish to exit to the character getBonuses screen?
    ...
    // Message: You must first getBonuses a user to invite to your party.
    YOU_MUST_FIRST_SELECT_A_USER_TO_INVITE_TO_YOUR_PARTY(185),
    // Message: You must first getBonuses a user to invite to your clan.
    ...
    // Message: You must first getBonuses a user to invite.
    ...
    // Message: Please getBonuses the quest you wish to abort.
    ...
    // Message: Please getBonuses the contact you wish to delete.  If you would like to delete a group, click the button next to My Status, and then use the Options menu.
    ...
    // Message: Please getBonuses the item you would like to try on.
    ...
    // Message: Please getBonuses the mail to be deleted.
