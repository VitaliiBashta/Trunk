...
public class ExCleftState extends L2GameServerPacket {
    private static final int CleftState_Total = 0;
    private static final int CleftState_TowerDestroy = 1;
    private static final int CleftState_CatUpdate = 2;
    private static final int CleftState_Result = 3;
    private static final int CleftState_PvPKill = 4;
