...
public final class ExBasicActionList extends L2GameServerPacket {
    private static final List<Integer> BasicActions = List.of(
            ...
            3, // Request for trade with the selected getPlayer. (/ trade)
            4, // Select the nearest target for attack. (/ targetnext)
            5, // pick up items around . (/ pickup)
            6, // Switch on the target selected getPlayer . (/ assist)
            7, // Invite selected getPlayer in your group. (/ invite)
            8, // Leave group . (/ leave)
            9, // If you are the group leader , delete the selected getPlayer (s) from the group . (/ dismiss)
            ...
            58, // Call another getPlayer to a duel . (/ duel)
