...
public class SystemMessage extends L2GameServerPacket {
    ...
    public static final int YOU_CAN_SELECT_SEVERAL_OPTIONS_RELATED_TO_THE_GAME_INCLUDING_GRAPHIC_SETTINGS_AND_SOUND_SETTINGS = 2857; // You can getBonuses several options related to the game, including graphic settings and sound settings.
    ...
    public static final int IF_YOU_CLICK_THE_CHAT_TAB_YOU_CAN_SELECT_AND_VIEW_THE_MESSAGES_OF_YOUR_DESIRED_GROUP_THE_TABS = 2868; // If you click the Chat tab, you can getBonuses and view the messages of your desired group. The tabs can be separated by using drag-and-drop.
    ...
    private SystemMessage addDoorName(int id) {
