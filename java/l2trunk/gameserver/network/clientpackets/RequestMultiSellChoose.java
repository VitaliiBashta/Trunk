...
import l2trunk.gameserver.model.base.MultiSellEntry;
...
public class RequestMultiSellChoose extends L2GameClientPacket {
        ...
        try {
            ...
            for (MultiSellIngredient ingridient : entry.getIngredients()) {
                ...
                if (ingridientItemId == ItemTemplate.ITEM_ID_CLAN_REPUTATION_SCORE) {
                    ...
                    ItemTemplate template = ItemHolder.INSTANCE.getTemplate(ingridientItemId);
            ...
            for (MultiSellIngredient in : entry.getProduction()) {
                ...
                } else if (ItemHolder.INSTANCE.getTemplate(in.getItemId()).isStackable()) {
    ...
    private class ItemData {
        ...
        ItemData(int id, long count, ItemInstance item) {
            _id = id;
            _count = count;
            _item = item;
        }
