...
import l2trunk.gameserver.network.serverpackets.PrivateStoreManageListBuy;
import l2trunk.gameserver.network.serverpackets.PrivateStoreMsgBuy;
...
public class SetPrivateStoreBuyList extends L2GameClientPacket {
    ...
    protected void readImpl() {
        _count = readD();
        if (_count * 40 > buf.remaining() || _count > Short.MAX_VALUE || _count < 1) {
            _count = 0;
            return;
        }
