...
import l2trunk.gameserver.network.loginservercon.gspackets.AuthRequest;
    ...
    public void run() {
        ...
        while (!shutdown) {
            ...
            try {
                ...
                _log.warn("waiting for Auth serever to accept connection");
            } catch (IOException e) {
