...
public class EnchantScrolls extends ScriptItemHandler implements ScriptFile {
    private static final int[] _itemIds = {729,
            730, 731, 732, 947, 948, 949, 950, 951, 952, 953, 954, 955, 956, 957,
            958, 959, 960, 961, 962, 6569, 6570, 6571, 6572, 6573, 6574, 6575, 6576,
            6577, 6578, 13540, 22006, 22007, 22008, 22009, 22010, 22011, 22012, 22013,
            22014, 22015, 22016, 22017, 22018, 22019, 22020, 22021, 20517, 20518,
            20519, 20520, 20521, 20522, 21581, 21582, 22221, 22222, 22223, 22224,
    ...
    public final int[] getItemIds() {
        ...
        Set<Integer> set = new HashSet<>(_itemIds.length + enchantScrolls.length);
        for (int i : _itemIds)
            set.add(i);
